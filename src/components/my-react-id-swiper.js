...
var MyReactIdSwiper = function (props) {
    ...
    var getSwiperInstance = function (swiper) {
        if (typeof getSwiper === 'function') {
            console.log('get swiper in my react swiper')
            getSwiper(swiper);
        }
    };
    // Destroy swiper
...
MyReactIdSwiper.displayName = 'MyReactIdSwiper';
exports.default = MyReactIdSwiper;
